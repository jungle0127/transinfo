...
namespace Trans.DAL.Dao
{
    ...
    public partial class VtrunkinformationDao : IVtrunkinformationDao
    {
        ...
        public IList<Vtrunkinformation> FindByTrunktypeid(Int64 trunktypeid)
        {
            String stmtId = "Vtrunkinformation.FindByTrunktypeid";
            IList<Vtrunkinformation> result = this.sqlMapper.QueryForList<Vtrunkinformation>(stmtId, trunktypeid);
            return result;
        }
        public IList<Vtrunkinformation> DescendOrderFindByTrunktypeid(Int64 trunktypeid)
        {
            String stmtId = "Vtrunkinformation.DescendOrderFindByTrunktypeid";
            IList<Vtrunkinformation> result = this.sqlMapper.QueryForList<Vtrunkinformation>(stmtId, trunktypeid);
            return result;
        }
        public IList<Vtrunkinformation> PaginationFindByTrunktypeid(VtrunkinformationPagination obj)
        {
            String stmtId = "VtrunkinformationPagination.FindByTrunktypeid";
            IList<Vtrunkinformation> result = this.sqlMapper.QueryForList<Vtrunkinformation>(stmtId, obj);
            return result;
        }
        public IList<Vtrunkinformation> DescendOrderPaginationFindByTrunktypeid(VtrunkinformationPagination obj)
        {
            String stmtId = "VtrunkinformationPagination.DescendOrderFindByTrunktypeid";
            IList<Vtrunkinformation> result = this.sqlMapper.QueryForList<Vtrunkinformation>(stmtId, obj);
            return result;
        }
        public int FindCountByTrunktypeid(Vtrunkinformation obj)
        {
            String stmtId = "Vtrunkinformation.GetFindByTrunktypeidCount";
            int result = this.sqlMapper.QueryForObject<int>(stmtId, obj);
            return result;
        }
        ...
        public IList<Vtrunkinformation> FindByLength(Int32 length)
        {
        ...
        public IList<Vtrunkinformation> DescendOrderFindByLength(Int32 length)
        {
        ...
        public IList<Vtrunkinformation> FindByWeightcapacity(Int32 weightcapacity)
        {
        ...
        public IList<Vtrunkinformation> DescendOrderFindByWeightcapacity(Int32 weightcapacity)
        {
        ...
        public IList<Vtrunkinformation> FindByVantypeid(Int64 vantypeid)
        {
            String stmtId = "Vtrunkinformation.FindByVantypeid";
            IList<Vtrunkinformation> result = this.sqlMapper.QueryForList<Vtrunkinformation>(stmtId, vantypeid);
            return result;
        }
        public IList<Vtrunkinformation> DescendOrderFindByVantypeid(Int64 vantypeid)
        {
            String stmtId = "Vtrunkinformation.DescendOrderFindByVantypeid";
            IList<Vtrunkinformation> result = this.sqlMapper.QueryForList<Vtrunkinformation>(stmtId, vantypeid);
            return result;
        }
        public IList<Vtrunkinformation> PaginationFindByVantypeid(VtrunkinformationPagination obj)
        {
            String stmtId = "VtrunkinformationPagination.FindByVantypeid";
            IList<Vtrunkinformation> result = this.sqlMapper.QueryForList<Vtrunkinformation>(stmtId, obj);
            return result;
        }
        public IList<Vtrunkinformation> DescendOrderPaginationFindByVantypeid(VtrunkinformationPagination obj)
        {
            String stmtId = "VtrunkinformationPagination.DescendOrderFindByVantypeid";
            IList<Vtrunkinformation> result = this.sqlMapper.QueryForList<Vtrunkinformation>(stmtId, obj);
            return result;
        }
        public int FindCountByVantypeid(Vtrunkinformation obj)
        {
            String stmtId = "Vtrunkinformation.GetFindByVantypeidCount";
            int result = this.sqlMapper.QueryForObject<int>(stmtId, obj);
            return result;
        }
        ...
        public IList<Vtrunkinformation> FindByVolume(Int32 volume)
        {
        ...
        public IList<Vtrunkinformation> DescendOrderFindByVolume(Int32 volume)
        {
