...
AS
SELECT users.id,rights.id AS rightid,rights.rightname,rights.righturl,rightgroup.groupname, 1 AS righttype from role_has_rights
...
UNION
select user_has_rights.userid AS id,rights.id as rightid,rights.righturl,rights.rightname,rightgroup.groupname,2 AS righttype from user_has_rights 
