...
-- Initial database
--
DROP DATABASE IF EXISTS `TransInfo`;
CREATE DATABASE `TransInfo` DEFAULT CHARACTER SET gbk;
USE TransInfo;
...
INSERT INTO role (rolename ) VALUES ('车主');
INSERT INTO role (rolename ) VALUES ('发货企业');
INSERT INTO role (rolename ) VALUES ('物流公司');
-- INSERT INTO role (rolename ) VALUES ('未审核');
...
INSERT INTO users (loginname ,username ,password ,roleid ) 
...
INSERT INTO rights (rightname ,righturl ) 
	VALUES ('公告发布','promulagate/newspublisher.aspx?id=2');	 -- 7
INSERT INTO rights (rightname ,righturl ) 
...
INSERT INTO rightgroup (groupname ) VALUES('个人信息');
INSERT INTO rightgroup (groupname ) VALUES('信息发布');
INSERT INTO rightgroup (groupname ) VALUES('权限管理');
INSERT INTO rightgroup (groupname ) VALUES('信息统计');
INSERT INTO rightgroup (groupname ) VALUES('信息管理');
INSERT INTO rightgroup (groupname ) VALUES('公告发布');
INSERT INTO rightgroup (groupname ) VALUES('公告管理');

--
-- Create table rightgroup_has_rights
--

DROP TABLE IF EXISTS `rightgroup_has_rights`;
CREATE TABLE `rightgroup_has_rights`(
	`id` bigint(20) auto_increment,
	...
	`active` tinyint DEFAULT 1 NOT NULL,
	PRIMARY KEY(id),
	FOREIGN KEY (groupid) REFERENCES rightgroup(id),
	FOREIGN KEY(rightid) REFERENCES  rights(id)
) ENGINE=InnoDB DEFAULT CHARSET=gbk;


CREATE INDEX IX_rightgrouphasrights_groupid ON rightgroup_has_rights (groupid);
CREATE INDEX IX_rightgrouphasrights_rightid ON rightgroup_has_rights (rightid);
...
INSERT INTO rightgroup_has_rights (groupid ,rightid ) VALUES(3,6);
INSERT INTO rightgroup_has_rights (groupid ,rightid ) VALUES(4,20);
INSERT INTO rightgroup_has_rights (groupid ,rightid ) VALUES(4,19);
INSERT INTO rightgroup_has_rights (groupid ,rightid ) VALUES(4,18);
INSERT INTO rightgroup_has_rights (groupid ,rightid ) VALUES(4,17);

INSERT INTO rightgroup_has_rights (groupid ,rightid ) VALUES(5,13);
INSERT INTO rightgroup_has_rights (groupid ,rightid ) VALUES(5,14);
INSERT INTO rightgroup_has_rights (groupid ,rightid ) VALUES(5,15);
INSERT INTO rightgroup_has_rights (groupid ,rightid ) VALUES(5,16);

INSERT INTO rightgroup_has_rights (groupid ,rightid ) VALUES(6,2);
INSERT INTO rightgroup_has_rights (groupid ,rightid ) VALUES(6,7);

INSERT INTO rightgroup_has_rights (groupid ,rightid ) VALUES(7,21);
INSERT INTO rightgroup_has_rights (groupid ,rightid ) VALUES(7,22);
INSERT INTO rightgroup_has_rights (groupid ,rightid ) VALUES(2,23);



--
-- create table role has rights
--
DROP TABLE IF EXISTS `role_has_rights`;
CREATE TABLE `role_has_rights`(
	`id` bigint(20) auto_increment,
	`roleid` bigint NOT NULL,
	`rightid` bigint NOT NULL,
	`active` tinyint DEFAULT 1 NOT NULL,
...
CREATE INDEX IX_rolehasrights_roleid ON role_has_rights (roleid);
CREATE INDEX IX_rolehasrights_rightid ON role_has_rights(rightid);
GO

INSERT INTO role_has_rights (roleid ,rightid ) VALUES (1,1);
INSERT INTO role_has_rights (roleid ,rightid ) VALUES (1,2);
INSERT INTO role_has_rights (roleid ,rightid ) VALUES (1,3);
INSERT INTO role_has_rights (roleid ,rightid ) VALUES (1,4);
INSERT INTO role_has_rights (roleid ,rightid ) VALUES (1,5);
INSERT INTO role_has_rights (roleid ,rightid ) VALUES (1,6);
INSERT INTO role_has_rights (roleid ,rightid ) VALUES (1,7);
INSERT INTO role_has_rights (roleid ,rightid ) VALUES (1,8);
INSERT INTO role_has_rights (roleid ,rightid ) VALUES (1,9);
INSERT INTO role_has_rights (roleid ,rightid ) VALUES (1,10);
INSERT INTO role_has_rights (roleid ,rightid ) VALUES (1,11);
INSERT INTO role_has_rights (roleid ,rightid ) VALUES (1,12);
INSERT INTO role_has_rights (roleid ,rightid ) VALUES (1,13);
INSERT INTO role_has_rights (roleid ,rightid ) VALUES (1,14);
INSERT INTO role_has_rights (roleid ,rightid ) VALUES (1,15);
INSERT INTO role_has_rights (roleid ,rightid ) VALUES (1,16);
INSERT INTO role_has_rights (roleid ,rightid ) VALUES (1,17);
INSERT INTO role_has_rights (roleid ,rightid ) VALUES (1,18);
INSERT INTO role_has_rights (roleid ,rightid ) VALUES (1,19);
INSERT INTO role_has_rights (roleid ,rightid ) VALUES (1,20);
...
--
-- Create table user_has_rights
--

DROP TABLE IF EXISTS `user_has_rights`;
CREATE TABLE `user_has_rights`(
	`id` bigint(20) auto_increment,
...
CREATE INDEX IX_userhasrights_userid ON user_has_rights(userid);
CREATE INDEX IX_userhasrights_rightid ON user_has_rights (rightid);
...
INSERT INTO articletype (typename) VALUES ('新闻');
INSERT INTO articletype (typename) VALUES ('公告');
...
CREATE INDEX IX_article_typeid ON article(typeid);
...
--
-- view of rights from all users
--
DROP VIEW IF EXISTS `V_userrights`;
CREATE VIEW `V_userrights`
AS
SELECT users.id,rights.id AS rightid,rights.rightname,rights.righturl,rightgroup.id AS groupid,rightgroup.groupname, 1 AS righttype from role_has_rights
...
UNION
select user_has_rights.userid AS id,rights.id as rightid,rights.righturl,rights.rightname,rightgroup.id AS groupid,rightgroup.groupname,2 AS righttype from user_has_rights 
join rights  on user_has_rights.rightid = rights.id
join rightgroup_has_rights  on rightgroup_has_rights.rightid = rights.id
join rightgroup  on rightgroup.id = rightgroup_has_rights.groupid;

--
-- view of rights full information.
--
DROP VIEW IF EXISTS `V_rightsfullinfo`;
CREATE VIEW `V_rightsfullinfo`
AS
select rights.id as rightId,rightgroup.id as groupId,rights.rightname,rights.righturl,rightgroup.groupname
from rightgroup_has_rights 
join rights  on rights.id = rightgroup_has_rights.rightid
join rightgroup  on rightgroup_has_rights.groupid = rightgroup.id;

--
-- view of user and related role information.
--

DROP VIEW IF EXISTS `V_userroleinfo`;
CREATE VIEW `V_userroleinfo`
AS
